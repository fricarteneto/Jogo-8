...
public class BuscaEmProfundidade {
		...
		private Stack<Peca[][]> filaAtual;
		private Stack<Peca[][]> filaVisitados;
		...
		public BuscaEmProfundidade() {
			...
			filaAtual = new Stack<Peca[][]>();
			filaVisitados = new Stack<Peca[][]>();
		...
		private void push(Peca[][] estado){
			filaAtual.push(estado);
			filaVisitados.push(estado);
		...
		public String iniciarBusca(){
			...
			for(;;){		
				...
				if(tab.isObjective(estadoAtual)){
					...
					Peca[][] aux = filaAtual.peek();
					expandirEspacos();
					filaAtual.remove(aux);
